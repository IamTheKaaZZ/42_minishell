...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_bin_128bit_str_bonus.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bcosters <bcosters@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/21 12:00:58 by bcosters          #+#    #+#             */
/*   Updated: 2021/04/08 16:49:57 by bcosters         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	handle_indexzero(t_ll input, int *negflag, char **str, int *i)
{
	if (input < 0)
	{
		*negflag = 1;
