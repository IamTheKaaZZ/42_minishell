...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_ui_to_base_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bcosters <bcosters@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/19 16:35:20 by bcosters          #+#    #+#             */
/*   Updated: 2021/05/24 10:26:34 by bcosters         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	reval(t_ui num, char *basestr)
{
...
static void	input_normal(t_ui input, char *basestr, char **res)
{
	size_t	i;
	size_t	base;
...
static void	input_zero(t_ui input, char *basestr, char **res)
{
	if (input == 0)
	{
		(*res)[0] = '0';
